...
class Match extends Phaser.Scene {
	...
	editorCreate() {
		...
		// bar2
		const bar2 = this.add.image(1575, 381, "Bar2");
		...
		// player2_deck
		const player2_deck = this.add.image(765, 368, "cartas4_Imprimir", 3);
		...
		// player1_deck1
		const player1_deck1 = this.add.image(516, 368, "cartas4_Imprimir", 3);
