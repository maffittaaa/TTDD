...
class Match extends Phaser.Scene {
	...
	editorCreate() {
		...
		// setHPTo1Text
		const setHPTo1Text = this.add.text(960, 384, "", {});
		...
		// resetHPText
		const resetHPText = this.add.text(906, 241, "", {});
		...
		levelPlayer1Text.setStyle({ "align": "center", "fontFamily": "Minecraft", "fontSize": "25px" });
		namesAndLevelsPlayers.add(levelPlayer1Text);

		// levelPlayer2Text
		const levelPlayer2Text = this.add.text(1565, 121, "", {});
		levelPlayer2Text.name = "levelPlayer2Text";
		levelPlayer2Text.setOrigin(0.5, 0.5);
		levelPlayer2Text.text = "Level: ";
		levelPlayer2Text.setStyle({ "align": "center", "fontFamily": "Minecraft", "fontSize": "25px" });
		...
		// showCards
		const showCards = this.add.text(288, 473, "", {});
