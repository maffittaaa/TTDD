create table player (
		...
		player_password VARCHAR(100), 					# player password
...
create table playerMatchCharacter (
		...
		player_match_character_character_attacked_id int null,					# character id of the character that already attacked
...
create table caracter (
		...
		caracter_range VARCHAR(30) not null, 				# character range (long or close-range)

		caracter_description VARCHAR(60) not null, 			# character attack description
...
create table matche (
		...
		matche_round_count int not null default 1, 			# number of rounds in the match
...
create table card (
		...
		card_description VARCHAR(200) not null, 			# the attack that the card does
...
create table deck (
		...
		deck_card_played VARCHAR(20) not null, 		# card played (true or false)
